/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     F:/Work/upwork/CC2640R2/MUX_ADC/sc code/adc level trigger.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2024-05-27 09:55:04.772
  * - <b>Computer</b>:         DESKTOP-2L91N3E
  * - <b>User</b>:             dicks
  *
  ...
  * - adc level trigger:
  *     - <b>A: 23</b>: DIO23
  *     - <b>O: Select S0</b>: DIO24
  *     - <b>O: Select S1</b>: DIO25
  *     - <b>O: Mux Select S2</b>: DIO26
  *     - <b>O: Mux Select S3</b>: DIO27
  *
  *
...
/// adc level trigger: 
#define SCIF_ADC_LEVEL_TRIGGER_CHANNELS 12
/// adc level trigger: 
#define SCIF_ADC_LEVEL_TRIGGER_SAMPLE_COUNT 8
/// adc level trigger I/O mapping: 23
#define SCIF_ADC_LEVEL_TRIGGER_DIO_A_ADC_INPUT0 23
/// adc level trigger I/O mapping: Select S0
#define SCIF_ADC_LEVEL_TRIGGER_DIO_O_S0 24
/// adc level trigger I/O mapping: Select S1
#define SCIF_ADC_LEVEL_TRIGGER_DIO_O_S1 25
/// adc level trigger I/O mapping: Mux Select S2
#define SCIF_ADC_LEVEL_TRIGGER_DIO_O_S2 26
/// adc level trigger I/O mapping: Mux Select S3
#define SCIF_ADC_LEVEL_TRIGGER_DIO_O_S3 27
